...
<!--                         <div class="col-md-6 col-sm-12">
        ...
        <div class="footer-container">          
            <footer class="classic">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4" id="confmsg">
                            <form class="form" >
                                ...
                                <div class="form-group">
                                    <input  type="email" name="email" id="email1" placeholder="enter your email" class="form-control"/>
                                </div>
                                <center>
                                    <a href="javascript:void" onclick="submitEmail()" class="btn btn-primary">subscribe</a>
                                </center>
                            </form>
                        </div>
        ...
        <script type="text/javascript">
            function submitEmail() {
                ...
                alert(email);
                document.getElementById("confmsg").innerHTML ='sending email';
                $.ajax({
                    type : "POST",
                    url : "/subscribe",
                    dataType : "html",
