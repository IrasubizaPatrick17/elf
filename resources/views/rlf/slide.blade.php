                   ...
                   <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive" align="center">
                                 ...
                                 <?php $i=0;?>
                                            @foreach($slide AS $value)
                                                <tr class="success">
                                                    ...
                                                    <td>
                                                        <button  data-toggle="modal" data-target="#editslide<?php  echo $i;?>" class="pull-left edit btn btn-sm btn-default dlt_sm_table"><i class="glyphicon glyphicon-pencil"></i>
                                                        </button><br><br>

                                            <form  class="pull-left" action="/slide/{{$value->id}}" method="POST">
                            ...
                            <div id="editslide<?php echo $i;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
