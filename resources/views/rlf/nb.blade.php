                ...
                <div class="modal-content" style="background: white;height: 500px;margin-top: 109px;">
                  <form role="form" action="" method="post">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                             ...
                             <div class="col-md-12">
                                    <label style="margin-left: 47%;margin-top: 28px;">National Player Breakfast</label>
                                    <hr>
                                </div><br><br>  

                            <div class="col-md-12">
                                <label>Registration Message</label>
                                <textarea class="form-control" placeholder="Enter text" name="nb"></textarea>
                   ...
                   <div class="row">
                    <div class="col-lg-12">
                        <h2>National player Breakfast</h2>
                        <div class="table-responsive" align="center">
                                 ...
                                 <?php $i=0;?>
                                            @foreach($nb AS $value)
                                                <tr >
                                                    ...
                                                    <td>{{$value->nb}}</td>
                                                    <td>
                                                        <button data-toggle="modal" data-target="#editnb<?php echo $i;?>" class="pull-left edit btn btn-sm btn-default dlt_sm_table"><i class="glyphicon glyphicon-pencil"></i>
                                                        </button><br><br>
                                            <form " class="pull-left" action="/nb/{{$value->id}}" method="POST">
                            ...
                            <div id="editnb<?php echo $i;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                           ...
                           <form action="/nb/{{$value->id}}" method="Post">
                           <div class="row">
                            ...
                            <div class="col-md-12" >
                                ...
                                <textarea rows="4" class="form-control" name="nb">
                                    {{$value->nb}}
                                </textarea>
