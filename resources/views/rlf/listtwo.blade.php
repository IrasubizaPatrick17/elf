            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form style="margin-left: 7%;" action="{{ url('importcsv') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                   ...
                   <div class="row">
                    <div class="col-lg-12">
                        <h2>Attendes In serena</h2>
                        
                        <div class="table-responsive display" id="demo" align="center">
                                  ...
                                  <?php $i=0;?>
                                            @foreach($invite AS $value)
                                                <tr >
                                                    ...
                                                    <td>{{$value->wife}}</td>
                                                  <td>
                                        <button data-toggle="modal" data-target="#editListtwo<?php echo $i;?>" class="pull-left edit btn btn-sm btn-default dlt_sm_table"><i class="glyphicon glyphicon-pencil"></i>
                                            </button><br><br>


                                        <form  class="pull-left" action="/listtwo/{{$value->id}}" method="POST">
                            ...
                            <div id="editListtwo<?php echo $i;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                        ...
                        <div class="container">               
                           <form action="/listtwo/{{$value->id}}" method="Post">
                           <div class="row">
