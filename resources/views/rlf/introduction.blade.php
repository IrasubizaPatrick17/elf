    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                 <button class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg" style="margin-left: -1174px;" class="close" > <i class="fa fa-plus"></i>Add introduction</button>
                ...
                <div class="modal-content" style="background: white;height: 500px;margin-top: 109px;">
                  <form role="form" action="" method="post">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                             ...
                             <div class="col-md-12">
                                    <label style="margin-left: 47%;margin-top: 28px;">Introduction</label>
                                    <hr>
                                </div><br><br>  
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" placeholder="Enter text" name="introduction" value="">
                                    
                                </textarea>
                            </div>

                            <div class="col-md-12" style="margin-left: 39%;margin-top: 10px;">
                                <label></label>
                   ...
                   <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive" align="center">
                                 ...
                                 <?php $i=0;?>
                                            @foreach($introduction AS $value)
                                                <tr >
                                                    ...
                                                    <td>
                                                        <button data-toggle="modal" data-target="#editIntroduction<?php echo $i;?>" class="pull-left edit btn btn-sm btn-default dlt_sm_table"><i class="glyphicon glyphicon-pencil"></i>
                                                        </button><br><br>
                                            <form " class="pull-left" action="/introduction/{{$value->id}}" method="POST">
                            ...
                            <div id="editIntroduction<?php echo $i;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog col-md-6 col-md-offset-3" style="margin-left: 33%;">
                                    <div class="modal-content" style= "height: 500px;">
                                        <div class="modal-header">
                                        <h4 class="modal-title" id="custom-width-modalLabel">Edit Introduction </h4></div>
                                        <div class="modal-body">
                                            
                           <form action="/introduction/{{$value->id}}" method="Post">
                           <div class="row">
                            ...
                            <div class="col-md-12" style="width: 200%;">
                                <label>Introduction</label>
                                <input class="form-control" placeholder="Enter text" name="introduction" 
