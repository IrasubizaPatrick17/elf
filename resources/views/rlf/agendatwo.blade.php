                   ...
                   <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive" align="center">
                                 ...
                                 <?php $i=0;?>
                                            @foreach($agendatwo AS $value)
                                                <tr >
                                                    ...
                                                    <td>
                                                        <button data-toggle="modal" data-target="#editAgendatwo<?php echo $i;?>" class="pull-left edit btn btn-sm btn-default dlt_sm_table"><i class="glyphicon glyphicon-pencil"></i>
                                                        </button><br><br>
                                            <form " class="pull-left" action="/agendatwo/{{$value->id}}" method="POST">
                            ...
                            <div id="editAgendatwo<?php echo $i;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                           ...
                           <form action="/agendatwo/{{$value->id}}" method="Post">
                           <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                value="{{$value->description}}"></textarea><br>
                            </div>
                            <div class="col-md-12">
                                <label>Genaral Introdution</label>
