 ...
 <ul class="nav navbar-right top-nav">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                 <button class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg" style="margin-left: -1174px;" class="close" > <i class="fa fa-plus"></i>Add welcome message</button>
                ...
                <div class="modal-content" style="background: white;height: 500px;margin-top: 109px;">
                  <form role="form" action="" method="post">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                             ...
                             <div class="col-md-12">
                                    <label style="margin-left: 47%;margin-top: 28px;">Welcome message</label>
                                    <hr>
                                </div><br><br>  

                            <div class="col-md-12">
                                <label>Title  of  welcome message</label>
                            ...
                            <div class="col-md-12" style="width: 200%;">
                                ...
                                <input class="form-control" placeholder="Enter text" name="video" value="">
                            </div>
                   ...
                   <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive" align="center">
                                 ...
                                 <?php $i=0;?>
                                            @foreach($welcome AS $value)
                                                <tr >
                                                    ...
                                                    <td>{{$value->video}}</td>
                                                    <td>
                                                        <button data-toggle="modal" data-target="#editWelcomemessage<?php echo $i;?>" class="pull-left edit btn btn-sm btn-default dlt_sm_table"><i class="glyphicon glyphicon-pencil"></i>
                                                        </button><br><br>
                                            <form " class="pull-left" action="/welcomemessage/{{$value->id}}" method="POST">
                            ...
                            <div id="editWelcomemessage<?php echo $i;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog col-md-6 col-md-offset-3" style="margin-left: 33%;">
                                    <div class="modal-content" style= "height: 500px;">
                                        <div class="modal-header">
                                        <h4 class="modal-title" id="custom-width-modalLabel">Edit welcome message</h4></div>
                                        <div class="modal-body">
                                            
                           <form action="/welcomemessage/{{$value->id}}" method="Post">
                           <div class="row">
                            ...
                            <div class="col-md-12" style="width: 200%;">
                                <label> Video Youtube Link </label>
                                <input class="form-control" placeholder="Enter text" name="video" value="{{$value->video}}">
                            </div>
                            ...
                            <div class="col-md-12" style="width: 200%;">
                                <label>Description</label>
                                <textarea class="form-control" rows="3" name="message" value="{{$value->description}}"></textarea><br>
                            </div><br>
